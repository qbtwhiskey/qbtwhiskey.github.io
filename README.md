...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 160 manually standardized sample reviews.
...
- 160 reviews have sample standardized tasting notes.
- 155 additional local reviews were transcribed after the initial 5-review sample.
