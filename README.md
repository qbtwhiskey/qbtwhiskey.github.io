...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 210 manually standardized sample reviews.
...
- 210 reviews have sample standardized tasting notes.
- 205 additional local reviews were transcribed after the initial 5-review sample.
