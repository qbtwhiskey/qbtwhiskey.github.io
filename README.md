...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 154 manually standardized sample reviews.
...
- 154 reviews have sample standardized tasting notes.
- 149 additional local reviews were transcribed after the initial 5-review sample.
