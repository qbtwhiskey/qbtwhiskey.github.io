...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 130 manually standardized sample reviews.
...
- 130 reviews have sample standardized tasting notes.
- 125 additional local reviews were transcribed after the initial 5-review sample.
