...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 202 manually standardized sample reviews.
...
- 202 reviews have sample standardized tasting notes.
- 197 additional local reviews were transcribed after the initial 5-review sample.
