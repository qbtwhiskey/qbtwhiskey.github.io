...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 88 manually standardized sample reviews.
...
- 88 reviews have sample standardized tasting notes.
- 83 additional local reviews were transcribed after the initial 5-review sample.
