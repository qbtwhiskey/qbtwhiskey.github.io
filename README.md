...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 115 manually standardized sample reviews.
...
- 115 reviews have sample standardized tasting notes.
- 110 additional local reviews were transcribed after the initial 5-review sample.
