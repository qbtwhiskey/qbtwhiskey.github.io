...
- `data/reviews.js` - indexed review data from the Google Drive inventory, now matched to the full local PDF set, with 77 manually standardized sample reviews.
...
- 77 reviews have sample standardized tasting notes.
- 72 additional local reviews were transcribed after the initial 5-review sample.
